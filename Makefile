...
FRAMEWORK_NAME = CSWeather
$(FRAMEWORK_NAME)_FILES = $(wildcard source/*.m)
$(FRAMEWORK_NAME)_PUBLIC_HEADERS = source/CSWeatherStore.h
$(FRAMEWORK_NAME)_INSTALL_PATH = /Library/Frameworks
$(FRAMEWORK_NAME)_FRAMEWORKS = UIKit CoreLocation
$(FRAMEWORK_NAME)_PRIVATE_FRAMEWORKS = Weather
